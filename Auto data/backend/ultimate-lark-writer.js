...
async function execute() {
  try {
    ...
    larkConfigs.forEach((config, index) => {
      ...
      console.log(`Lark API请求体:`, JSON.stringify(larkApiBody, null, 2).substring(0, 500) + "...");
